							...
							<table width="100" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td height="38" align="center">
										<a href="<%=basePath%>index" class="left"> 首页</a>
									</td>
								</tr>
							</table>
						</li>
					...
					<td align="left">
							<li>
								<table width="100" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td height="38" align="center">
											<a href="index/goods.action" class="left">建材物资</a>
										</td>
									</tr>
								</table>
							</li>
										...
										<tr>
											<td align=left>
												<table width="100" height="35" border="0" cellpadding="0">
													<tr>
														<td align="left">
															<a href="index/preOrders.action"><font class="p14"><img src="images/biao.gif"
																	alt="图标" border="0">&nbsp;预约租赁</font> </a>
														</td>
													</tr>
												</table>
											</td>
										...
										<tr>
											<td align=left>
												<table width="100" height="35" border="0" cellpadding="0">
													<tr>
														<td align="left">
															<a href="index/myOrders.action"><font class="p14"><img src="images/biao.gif"
																	alt="图标" border="0">&nbsp;我的租赁</font> </a>
														</td>
													</tr>
												</table>
											</td>
