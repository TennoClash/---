			...
			<td align="center" valign="top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="bg_qc">
					<tr>
						...
						<td align="left" class="p12">您的位置： <a href="index">首页</a>&nbsp;&gt;&nbsp;&nbsp;用户注册
						</td>
					</tr>
				</table>
				...
				<form action="index/register.action" autocomplete="off" method="post" name="myform" id="myform">
					<table width="56%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
						...
						<tr>
							<td height="50" align="right" bgcolor="#FFFFFF">联系电话：</td>
							<td bgcolor="#FFFFFF"><input type="text" name="phone" style="width: 260px; height: 30px" id="phone" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td bgcolor="#FFFFFF" colspan="2" align="center"><label> <input type="submit" id="btn" name="btn"
