					...
					<tr>
						<td valign="top">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="90" height="28" align="center" background="images/nzcms/left.gif" class="title14b">信息导航</td>
							...
							<table width="98%" height="24" border="0" align="center" cellpadding="0" cellspacing="0">
								<c:forEach items="${bannerList}" var="banner">
									<tr>
										<td height="27" align="left" valign="middle">&nbsp; <img src="images/HOT2.gif" width="7" height="7" />
											&nbsp; <a href="index/article.action?id=${banner.bannerid }" title="标题：${banner.bannername }">${banner.bannername }</a>
										</td>
									</tr>
								</c:forEach>
							</table>
			...
			<td align="center">
				<table width="98%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="bg_qc">
					<tr>
						...
						<td align="left" class="p12">您的位置：<a href="index">首页</a>&nbsp;&gt;&nbsp;&nbsp;建材物资信息
						</td>
					</tr>
				</table>
				<table height="10" border="0" cellpadding="0" cellspacing="0">
				...
				<table width="98%" border="0" cellpadding="0" cellspacing="0" background="images/nzcms/list_news_bg.gif">
					<tr>
						<td width="190" height="33" align="center" class="title14b">建材物资信息</td>
						<td align="right">&nbsp;&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
				</table>
				...
				<table border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FF9900">
					<tr>
						<c:forEach items="${goodsList}" var="goods" varStatus="status">
							...
							<td align="center" valign="top" whith="200"><table width="170" height="150" border="1" cellpadding="0"
									cellspacing="3" bordercolor="#FFFFFF" bgcolor="#F5F5F5" class="bg_qc">
									<tr>
										<td align="center" valign="middle" bgcolor="#FFFFFF"><a
											href="index/goodsDetail.action?id=${goods.goodsid }" target="_blank"><img src="${goods.image }"
												alt="${goods.goodsname }" width="190" height="140" border="0"></a></td>
									</tr>
								</table>
								<table width="220" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td height="35" align="center"><a href="index/goodsDetail.action?id=${goods.goodsid }" target="_blank">
