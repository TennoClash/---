...
$(document).ready(
		function() {
			var url = "/fms/index/getkey.action";
			var Modulus;
			...
			$("#button1").on("click",function() {
						...
						if (password != null && username != ""&& password != null && username != "") {
						 	var url = "/fms/index/login.action";
							var param = {
									username : username,
									password : password
							};
							$.post(url, param, function(data) {
								...
								if (data == "1") {
									location.href = "/fms/index/index.action"
								}else{
									alert(data);
								}
							});
			...
			<td align="center" valign="top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="bg_qc">
					<tr>
						...
						<td align="left" class="p12">您的位置： <a href="index">首页</a>&nbsp;&gt;&nbsp;&nbsp;用户登录
						</td>
					</tr>
				</table>
				...
				<form action="index/login.action" method="post" name="myform">
					<table width="46%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
						<tr>
							<td height="30" colspan="2" align="center" background="images/nzcms/list_bg.gif" class="white14B">用户登录</td>
						</tr>
						<tr>
						...
						<tr>
							<td bgcolor="#FFFFFF" colspan="2" align="center"><label> <input type="button" name="Submit"
									id="button1" value="提交" /> &nbsp;&nbsp;&nbsp;&nbsp; <input type="reset" name="Submit2" value="重置" />
							</label></td>
						</tr>
					</table>
				</form>
