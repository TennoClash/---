			...
			<div class="row">
				<div class="col-md-12">
					<div class="card form" id="form2">
						...
						<br>
						<form action="book/addBook.action" autocomplete="off" name="myform" method="post" onsubmit="return check()">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										<label style="width: 85px;" class=" col-form-label">收支单号</label>
										<div class="col-9">
											<input type="text" name="bookno" class="form-control" id="bookno" readonly="readonly" value="${bno }" />
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-9">
											<input type="text" name="money" class="form-control" id="money" placeholder="请输入金额" />
										</div>
									</div>
									<div class="form-group row">
