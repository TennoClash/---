			...
			<div class="row">
				<table class="table table-hover">
					...
					<c:forEach items="${kindList}" var="kind">
						<tr align="center">
							<td>${kind.kindname}</td>
							<td><a href="kind/getKindById.action?id=${kind.kindid}">编辑</a>&nbsp;&nbsp;<a
								href="kind/deleteKind.action?id=${kind.kindid}" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a></td>
						</tr>
					</c:forEach>
				</table>
			</div>
