			...
			<div class="row">
				<div class="col-md-12">
					<div class="card form" id="form2">
						...
						<br>
						<form action="banner/addBanner.action" autocomplete="off" name="myform" method="post" onsubmit="return check()">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										<label style="width: 85px;" class=" col-form-label">主题名称</label>
										<div class="col-9">
											<input type="text" name="bannername" class="form-control" id="bannername" placeholder="请输入主题名称" />
										</div>
									</div>
