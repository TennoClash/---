			...
			<div class="row">
				<div class="col-md-12">
					<div class="card form" id="form2">
						...
						<br>
						<form action="kind/addKind.action" autocomplete="off" name="myform" method="post" onsubmit="return check()">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										<label style="width: 85px;" class=" col-form-label">类型名称</label>
										<div class="col-9">
											<input type="text" name="kindname" class="form-control" id="kindname" placeholder="请输入类型名称" />
										</div>
									</div>
