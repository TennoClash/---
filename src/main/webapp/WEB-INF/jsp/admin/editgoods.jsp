			...
			<div class="row">
				<div class="col-md-12">
					<div class="card form" id="form2">
						...
						<br>
						<form action="goods/updateGoods.action" autocomplete="off" name="myform" method="post" onsubmit="return check()">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										<label style="width: 85px;" class=" col-form-label">建材名称</label>
										<div class="col-9">
											<input type="text" name="goodsname" class="form-control" id="goodsname" value="${goods.goodsname}" />
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-9">
											...
											<input class="form-control" type="text" name="goods.image" id="image" onclick="selimage();"
												placeholder="请选择图片" value="${goods.image}" readonly="readonly" />
										</div>
									</div>
									<div class="form-group row">
										<label style="width: 85px;" class=" col-form-label">出租价格</label>
										<div class="col-9">
											<input type="text" name="price" class="form-control" id="price" value="${goods.price}" />
										</div>
									</div>
									<div class="form-group row">
