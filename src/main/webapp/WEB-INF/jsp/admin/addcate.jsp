			...
			<div class="row">
				<div class="col-md-12">
					<div class="card form" id="form2">
						...
						<br>
						<form action="cate/addCate.action" autocomplete="off" name="myform" method="post" onsubmit="return check()">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										<label style="width: 85px;" class=" col-form-label">项目名称</label>
										<div class="col-9">
											<input type="text" name="catename" class="form-control" id="catename" placeholder="请输入项目名称" />
										</div>
									</div>
									<div class="form-group row">
